...
CREATE DATABASE IF NOT EXISTS `nkap-scour` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `nkap-scour`;
...
-- Listage des données de la table nkap-scour.annee_scolaire : ~0 rows (environ)
/*!40000 ALTER TABLE `annee_scolaire` DISABLE KEYS */;
INSERT IGNORE INTO `annee_scolaire` (`id`, `code`, `slogan`, `mission`, `debut_annee`, `fin_annee`, `statut`, `creer_par`, `date_creation`, `modifier_par`, `date_modification`, `supprimer_par`, `date_suppression`, `visibilite`) VALUES
	(1, 'ANSCO-01', 'Annee des lumieres', 'Produire les meilleurs eleves du monde', '2019-09-15 08:00:00', '2020-05-15 15:30:00', '1', 0, '2020-08-10 17:07:21', NULL, NULL, NULL, NULL, '1'),
	(2, 'CORE_1598613732', NULL, NULL, '2020-08-28 11:22:12', '2021-08-28 11:22:12', '1', 0, '2020-08-28 12:22:12', NULL, NULL, NULL, NULL, '1');
...
-- Listage des données de la table nkap-scour.antecedent_scolaire : ~70 rows (environ)
...
-- Listage des données de la table nkap-scour.classe : ~9 rows (environ)
...
INSERT IGNORE INTO `classe` (`id`, `cycle_id`, `code`, `libelle`, `description`, `scolarite_min`, `scolarite_max`, `creer_par`, `date_creation`, `modifier_par`, `date_modification`, `supprimer_par`, `date_suppression`, `visibilite`) VALUES
	(1, 3, 'SECTION_1', 'Petite-section', 'A', 200456, 435000, 0, '2020-08-10 17:07:21', NULL, NULL, NULL, NULL, '1'),
	(2, 2, 'SECTION_2', 'Moyenne-section', 'A', 300400, 470000, 0, '2020-08-10 17:07:21', NULL, NULL, NULL, NULL, '1'),
	...
	(6, 2, 'CE1', 'Cours-Elementaire 1', '', 500456, 735000, 0, '2020-08-10 17:07:21', NULL, NULL, NULL, NULL, '1'),
	(7, 2, 'CE2', 'Cours-Elementaire 2', '', 500456, 735000, 0, '2020-08-10 17:07:21', NULL, NULL, NULL, NULL, '1'),
	(8, 1, 'CM1', 'Cours-Moyen 1', 'A', 500456, 735000, 0, '2020-08-10 17:07:21', NULL, NULL, NULL, NULL, '1'),
	(9, 2, 'CM2', 'Cours-Moyen 2', '', 500456, 735000, 0, '2020-08-10 17:07:21', NULL, NULL, NULL, NULL, '1');
...
-- Listage des données de la table nkap-scour.dossier_medical : ~61 rows (environ)
...
-- Listage des données de la table nkap-scour.dossier_parental : ~44 rows (environ)
...
-- Listage des données de la table nkap-scour.eleve : ~11 rows (environ)
...
INSERT IGNORE INTO `eleve` (`id`, `code`, `dossier_medical_id`, `pays_id`, `dossier_parental_id`, `antecedent_scolaire_id`, `matricule`, `nom`, `prenom`, `sexe`, `date_naissance`, `lieu_naissance`, `photo`, `anciennete`, `creer_par`, `date_creation`, `modifier_par`, `date_modification`, `supprimer_par`, `date_suppression`, `visibilite`) VALUES
	(1, 'ELEV_1598610091', 40, 1, 30, 49, '2019-09-15 08:00:00A000', 'TSUALA', 'Florian', 'H', '2020-08-15 00:00:00', 'A', 'no-photo.jpg', 0, 0, '2020-08-28 11:21:31', NULL, NULL, NULL, NULL, '1'),
	...
	(4, 'ELEV_1598610803', 46, 1, 36, 55, '1919-0', 'TSUALA', 'Florian', 'H', '2020-08-15 00:00:00', 'A', 'no-photo.jpg', 0, 0, '2020-08-28 11:33:23', NULL, NULL, NULL, NULL, '1'),
	...
	(6, 'ELEV_1598611007', 49, 1, 39, 58, '19A001', 'TSUALA', 'Florian', 'H', '2020-08-15 00:00:00', 'A', 'no-photo.jpg', 0, 0, '2020-08-28 11:36:47', NULL, NULL, NULL, NULL, '1'),
	...
	(9, 'ELEV_1598611714', 59, 1, 49, 68, '19A004', 'TSUALA', 'Florian', 'H', '2020-08-15 00:00:00', 'A', 'no-photo.jpg', 0, 0, '2020-08-28 11:48:34', NULL, NULL, NULL, NULL, '1'),
	(10, 'ELEV_1598611721', 60, 1, 50, 69, '19A005', 'TSUALA', 'Florian', 'H', '2020-08-15 00:00:00', 'A', 'no-photo.jpg', 0, 0, '2020-08-28 11:48:41', NULL, NULL, NULL, NULL, '1'),
	(11, 'ELEV_1598611726', 61, 1, 51, 70, '19A006', 'TSUALA', 'Florian', 'H', '2020-08-15 00:00:00', 'A', 'no-photo.jpg', 0, 0, '2020-08-28 11:48:46', NULL, NULL, NULL, NULL, '1'),
	(12, 'ELEV_1598611820', 62, 1, 52, 71, '19A007', 'TSUALA', 'Florian', 'H', '2020-08-15 00:00:00', 'A', 'no-photo.jpg', 0, 0, '2020-08-28 11:50:20', NULL, NULL, NULL, NULL, '1'),
	(13, 'ELEV_1598611931', 63, 1, 53, 72, '19A008', 'TSUALA', 'Florian', 'H', '2020-08-15 00:00:00', 'A', 'no-photo.jpg', 0, 0, '2020-08-28 11:52:11', NULL, NULL, NULL, NULL, '1'),
	(14, 'ELEV_1598612004', 64, 1, 54, 73, '19A009', 'TSUALA', 'Florian', 'H', '2020-08-15 00:00:00', 'A', 'no-photo.jpg', 0, 0, '2020-08-28 11:53:24', NULL, NULL, NULL, NULL, '1'),
	...
	(16, 'ELEV_1598612137', 66, 1, 56, 75, '19A011', 'TSUALA', 'Florian', 'H', '2020-08-15 00:00:00', 'A', 'no-photo.jpg', 0, 0, '2020-08-28 11:55:37', NULL, NULL, NULL, NULL, '1'),
...
-- Listage des données de la table nkap-scour.parcours : ~0 rows (environ)
...
-- Listage des données de la table nkap-scour.pays : ~5 rows (environ)
...
-- Listage des données de la table nkap-scour.pension_classe : ~0 rows (environ)
...
INSERT IGNORE INTO `personnel` (`id`, `type_personnel_id`, `pays_id`, `code`, `nom`, `prenom`, `sexe`, `photo`, `telephone`, `email`, `adresse`, `login`, `password`, `date_prise_service`, `date_fin_carriere`, `bibliographie`, `creer_par`, `date_creation`, `modifier_par`, `date_modification`, `supprimer_par`, `date_suppression`, `visibilite`) VALUES
	...
	(2, 2, 1, 'PERSO-02', 'TSUALA', 'Florian', 'H', 'no-photo.jpg', '+241 66 39 63 33', 'florian@yahoo.fr', 'Rue NTOUMAMANE 23', 'florian', '650a7fe5b3c1048c21706249a213cdc7', '2013-06-12 19:49:39', NULL, 'Homme pragmatique et travailleur', 0, '2020-04-24 19:49:39', NULL, NULL, NULL, NULL, '1'),
...
-- Listage des données de la table nkap-scour.salle_classe : ~0 rows (environ)
...
-- Listage des données de la table nkap-scour.tranche_scolaire : ~0 rows (environ)
...
-- Listage des données de la table nkap-scour.type_paiement : ~0 rows (environ)
...
-- Listage des données de la table nkap-scour.type_pension : ~0 rows (environ)
