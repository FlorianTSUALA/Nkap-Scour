...
CREATE DATABASE IF NOT EXISTS `nkap-scour` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `nkap-scour`;
...
CREATE TABLE IF NOT EXISTS `abonnement_activite` (
  ...
  `periode` enum('JOUR','SEMAINE','MOIS','ANNEE') DEFAULT 'MOIS',
  `multiplicateur` int(3) NOT NULL,
  `montant_unitaire` float DEFAULT NULL,
  `montant_total` float DEFAULT NULL,
  `reduction` float DEFAULT NULL,
  `resume_periode` varchar(255) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `FK_eleve_activite` (`eleve_id`),
  CONSTRAINT `FK_eleve_activite` FOREIGN KEY (`eleve_id`) REFERENCES `eleve` (`id`)
...
-- Listage de la structure de la table nkap-scour. abonnement_cantine
...
CREATE TABLE IF NOT EXISTS `abonnement_cantine` (
  ...
  CONSTRAINT `fk_eleve_abonnement_cantine` FOREIGN KEY (`eleve_id`) REFERENCES `eleve` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4;

-- Listage des données de la table nkap-scour.abonnement_cantine : ~8 rows (environ)
/*!40000 ALTER TABLE `abonnement_cantine` DISABLE KEYS */;
INSERT INTO `abonnement_cantine` (`id`, `code`, `eleve_id`, `reference`, `montant_total`, `reduction`, `date_debut`, `date_fin`, `date_paiement`, `creer_par`, `date_creation`, `modifier_par`, `date_modification`, `supprimer_par`, `date_suppression`, `visibilite`) VALUES
	(1, 'CORE_1610385747', 1, 'EEE0AFC03D', 64999, 1, '2021-11-01 00:00:00', '2021-09-12 00:00:00', '2021-01-11 01:00:00', 0, '2021-01-11 18:22:27', NULL, NULL, NULL, NULL, '1'),
	(2, 'CORE_1610394338', 1, '5C9EBA2B66', 315000, 0, '2021-11-01 00:00:00', '2022-06-05 00:00:00', '2021-01-11 01:00:00', 0, '2021-01-11 20:45:38', NULL, NULL, NULL, NULL, '1'),
	(3, 'CORE_1610395522', 1, '5C9EBA2B66', 315000, 0, '2021-11-01 00:00:00', '2022-06-05 00:00:00', '2021-01-11 01:00:00', 0, '2021-01-11 21:05:22', NULL, NULL, NULL, NULL, '1'),
	(4, 'CORE_1610395574', 1, '5C9EBA2B66', 315000, 0, '2021-11-01 00:00:00', '2022-06-05 00:00:00', '2021-01-11 01:00:00', 0, '2021-01-11 21:06:14', NULL, NULL, NULL, NULL, '1'),
	(5, 'CORE_1610405354', 1, '5C9EBA2B66', 315000, 0, '2021-11-01 00:00:00', '2022-06-05 00:00:00', '2021-01-11 01:00:00', 0, '2021-01-11 23:49:14', NULL, NULL, NULL, NULL, '1'),
	(6, 'CORE_1610405741', 1, '3FCD047E45', 65000, 0, '2021-11-01 00:00:00', '2021-09-12 00:00:00', '2021-01-11 01:00:00', 0, '2021-01-11 23:55:41', NULL, NULL, NULL, NULL, '1'),
	(7, 'CORE_1610406423', 1, '08384630EB', 215000, 0, '2021-11-01 00:00:00', '2022-09-03 00:00:00', '2021-01-11 01:00:00', 0, '2021-01-12 00:07:03', NULL, NULL, NULL, NULL, '1'),
	(8, 'CORE_1610406908', 1, '3FCD047E45', 65000, 0, '2021-11-01 00:00:00', '2021-09-12 00:00:00', '2021-01-11 01:00:00', 0, '2021-01-12 00:15:08', NULL, NULL, NULL, NULL, '1'),
	(9, 'CORE_1610407206', 1, '3FCD047E45', 65000, 0, '2021-11-01 00:00:00', '2021-09-12 00:00:00', '2021-01-11 01:00:00', 0, '2021-01-12 00:20:06', NULL, NULL, NULL, NULL, '1'),
	(10, 'CORE_1610407246', 1, 'DB1F79E456', 2500, 0, '2021-11-01 00:00:00', '2021-02-11 00:00:00', '2021-01-11 01:00:00', 0, '2021-01-12 00:20:46', NULL, NULL, NULL, NULL, '1');
...
CREATE TABLE IF NOT EXISTS `abonnement_consomme` (
  ...
  CONSTRAINT `fk_abonnement_restoCheckListResto` FOREIGN KEY (`abonnement_resto_id`) REFERENCES `abonnement_cantine` (`id`),
...
-- Listage de la structure de la table nkap-scour. abonnement_detail
DROP TABLE IF EXISTS `abonnement_detail`;
CREATE TABLE IF NOT EXISTS `abonnement_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(254) DEFAULT NULL,
  `cantine_id` int(11) DEFAULT NULL,
  `periode` enum('JOUR','SEMAINE','MOIS','ANNEE') DEFAULT 'JOUR',
...
-- Listage des données de la table nkap-scour.abonnement_detail : ~22 rows (environ)
/*!40000 ALTER TABLE `abonnement_detail` DISABLE KEYS */;
INSERT INTO `abonnement_detail` (`id`, `code`, `cantine_id`, `periode`, `multiplicateur`, `prix_unitaire`, `total`, `date_debut`, `date_fin`, `creer_par`, `date_creation`, `modifier_par`, `date_modification`, `supprimer_par`, `date_suppression`, `visibilite`) VALUES
	(1, 'CORE_1610395522', 3, 'JOUR', 1, NULL, 2500, '2021-11-01 00:00:00', '2021-11-02 00:00:00', 0, '2021-01-11 21:05:22', NULL, NULL, NULL, NULL, '1'),
	(2, 'CORE_1610395522', 3, 'SEMAINE', 5, NULL, 62500, '2021-11-02 00:00:00', '2021-11-09 00:00:00', 0, '2021-01-11 21:05:22', NULL, NULL, NULL, NULL, '1'),
	(3, 'CORE_1610395522', 3, 'MOIS', 5, NULL, 250000, '2021-11-09 00:00:00', '2021-12-09 00:00:00', 0, '2021-01-11 21:05:22', NULL, NULL, NULL, NULL, '1'),
	(4, 'CORE_1610395574', 4, 'JOUR', 1, 2500, 2500, '2021-11-01 00:00:00', '2021-11-02 00:00:00', 0, '2021-01-11 21:06:14', NULL, NULL, NULL, NULL, '1'),
	(5, 'CORE_1610395574', 4, 'SEMAINE', 5, 12500, 62500, '2021-11-02 00:00:00', '2021-11-09 00:00:00', 0, '2021-01-11 21:06:14', NULL, NULL, NULL, NULL, '1'),
	(6, 'CORE_1610395574', 4, 'MOIS', 5, 50000, 250000, '2021-11-09 00:00:00', '2021-12-09 00:00:00', 0, '2021-01-11 21:06:14', NULL, NULL, NULL, NULL, '1'),
	(7, 'CORE_1610405354', 5, 'JOUR', 1, 2500, 2500, '2021-11-01 00:00:00', '2021-11-02 00:00:00', 0, '2021-01-11 23:49:14', NULL, NULL, NULL, NULL, '1'),
	(8, 'CORE_1610405354', 5, 'SEMAINE', 5, 12500, 62500, '2021-11-02 00:00:00', '2021-11-09 00:00:00', 0, '2021-01-11 23:49:14', NULL, NULL, NULL, NULL, '1'),
	(9, 'CORE_1610405354', 5, 'MOIS', 5, 50000, 250000, '2021-11-09 00:00:00', '2021-12-09 00:00:00', 0, '2021-01-11 23:49:14', NULL, NULL, NULL, NULL, '1'),
	(10, 'CORE_1610405741', 6, 'JOUR', 1, 2500, 2500, '2021-11-01 00:00:00', '2021-11-02 00:00:00', 0, '2021-01-11 23:55:41', NULL, NULL, NULL, NULL, '1'),
	(11, 'CORE_1610405741', 6, 'SEMAINE', 1, 12500, 12500, '2021-11-02 00:00:00', '2021-11-09 00:00:00', 0, '2021-01-11 23:55:41', NULL, NULL, NULL, NULL, '1'),
	(12, 'CORE_1610405741', 6, 'MOIS', 1, 50000, 50000, '2021-11-09 00:00:00', '2021-12-09 00:00:00', 0, '2021-01-11 23:55:41', NULL, NULL, NULL, NULL, '1'),
	(13, 'CORE_1610406423', 7, 'JOUR', 1, 2500, 2500, '2021-11-01 00:00:00', '2021-11-02 00:00:00', 0, '2021-01-12 00:07:03', NULL, NULL, NULL, NULL, '1'),
	(14, 'CORE_1610406423', 7, 'SEMAINE', 1, 12500, 12500, '2021-11-02 00:00:00', '2021-11-09 00:00:00', 0, '2021-01-12 00:07:03', NULL, NULL, NULL, NULL, '1'),
	(15, 'CORE_1610406423', 7, 'MOIS', 4, 50000, 200000, '2021-11-09 00:00:00', '2021-12-09 00:00:00', 0, '2021-01-12 00:07:03', NULL, NULL, NULL, NULL, '1'),
	(16, 'CORE_1610406908', 8, 'JOUR', 1, 2500, 2500, '2021-11-01 00:00:00', '2021-11-02 00:00:00', 0, '2021-01-12 00:15:08', NULL, NULL, NULL, NULL, '1'),
	(17, 'CORE_1610406908', 8, 'SEMAINE', 1, 12500, 12500, '2021-11-02 00:00:00', '2021-11-09 00:00:00', 0, '2021-01-12 00:15:08', NULL, NULL, NULL, NULL, '1'),
	(18, 'CORE_1610406908', 8, 'MOIS', 1, 50000, 50000, '2021-11-09 00:00:00', '2021-12-09 00:00:00', 0, '2021-01-12 00:15:08', NULL, NULL, NULL, NULL, '1'),
	(19, 'CORE_1610407206', 9, 'JOUR', 1, 2500, 2500, '2021-11-01 00:00:00', '2021-11-02 00:00:00', 0, '2021-01-12 00:20:06', NULL, NULL, NULL, NULL, '1'),
	(20, 'CORE_1610407206', 9, 'SEMAINE', 1, 12500, 12500, '2021-11-02 00:00:00', '2021-11-09 00:00:00', 0, '2021-01-12 00:20:06', NULL, NULL, NULL, NULL, '1'),
	(21, 'CORE_1610407206', 9, 'MOIS', 1, 50000, 50000, '2021-11-09 00:00:00', '2021-12-09 00:00:00', 0, '2021-01-12 00:20:06', NULL, NULL, NULL, NULL, '1'),
	(22, 'CORE_1610407246', 10, 'JOUR', 1, 2500, 2500, '2021-11-01 00:00:00', '2021-11-02 00:00:00', 0, '2021-01-12 00:20:46', NULL, NULL, NULL, NULL, '1');
/*!40000 ALTER TABLE `abonnement_detail` ENABLE KEYS */;
...
-- Listage de la structure de la table nkap-scour. affectation_classe_matiere
DROP TABLE IF EXISTS `affectation_classe_matiere`;
CREATE TABLE IF NOT EXISTS `affectation_classe_matiere` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `matiere_id` int(11) NOT NULL,
  `classe_id` int(11) NOT NULL,
  `code` varchar(254) DEFAULT NULL,
  `coefficient` float DEFAULT '0',
  `volume_horaire` float DEFAULT '0',
  `creer_par` int(11) DEFAULT '0' COMMENT '{0 => SuperAdmin}',
  `date_creation` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modifier_par` int(11) DEFAULT NULL,
  `date_modification` datetime DEFAULT NULL,
  ...
  `visibilite` enum('1','0') DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `fk_classe_affecter` (`classe_id`),
  KEY `fk_matiere_affecter` (`matiere_id`),
  CONSTRAINT `fk_classe_affecter` FOREIGN KEY (`classe_id`) REFERENCES `classe` (`id`),
  CONSTRAINT `fk_matiere_affecter` FOREIGN KEY (`matiere_id`) REFERENCES `matiere` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Listage des données de la table nkap-scour.affectation_classe_matiere : ~0 rows (environ)
/*!40000 ALTER TABLE `affectation_classe_matiere` DISABLE KEYS */;
/*!40000 ALTER TABLE `affectation_classe_matiere` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `cours` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `affecter_classe_matiere_id` int(11) NOT NULL,
  ...
  `visibilite` enum('1','0') DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `fk_est_enseignee_classe` (`affecter_classe_matiere_id`),
  ...
  CONSTRAINT `fk_est_enseignee_classe` FOREIGN KEY (`affecter_classe_matiere_id`) REFERENCES `affectation_classe_matiere` (`id`),
...
-- Listage des données de la table nkap-scour.discipline : ~3 rows (environ)
...
-- Listage de la structure de la table nkap-scour. groupe_familial
...
-- Listage des données de la table nkap-scour.matiere : ~20 rows (environ)
...
-- Listage des données de la table nkap-scour.pension_classe : ~3 rows (environ)
...
CREATE TABLE IF NOT EXISTS `planning_resto` (
  ...
  CONSTRAINT `fk_abonnement_resto_planning_resto` FOREIGN KEY (`abonnement_id`) REFERENCES `abonnement_cantine` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
-- Listage de la structure de la table nkap-scour. prix_abonnement
...
CREATE TABLE IF NOT EXISTS `prix_abonnement` (
  ...
  `montant` float DEFAULT NULL,
  `periode` enum('JOUR','SEMAINE','MOIS','ANNEE') COLLATE utf8_unicode_ci DEFAULT 'MOIS',
...
-- Listage des données de la table nkap-scour.type_pension : ~6 rows (environ)
