<!-- Step 5 -->
<h6><strong>Vérification des informations saisies</strong></h6>
<fieldset>
    <div class="row">
        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-5">
                                    <div class="row">
                                        ...
                                        <em class="col-6">MAVOUGOU MBA OBIANG</em>
                                    </div>
                                </div>
                                ...
                                <div class="col-5">
                                    <div class="row">
                                        ...
                                        <em class="col-6">Albert Steve François</em>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-5">
                                    <div class="row">
                                        ...
                                        <em class="col-6">Gustave Flaubert</em>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-1">
                                ...
                                <div class="col-5">
                                    <div class="row">
                                        ...
                                        <em class="col-6 danger"><?= repeatChar();?></em>
                                    </div>
                                </div>
                            </div>
