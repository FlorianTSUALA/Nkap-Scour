...
fields: [
    ...
    { name: "Country", type: "select", items: db.countries, valueField: "Id", textField: "Name", align: "center" },
    { name: "Married", type: "checkbox", title: "Is Married", sorting: false, align: "center" },
    { type: "control" }
]
});
