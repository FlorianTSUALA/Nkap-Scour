    ...
    <div class="col-12 d-flex align-items-center justify-content-center">
        <div class="col-md-4 col-10 p-0">
            <div class="card-header bg-transparent border-0">
                ...
                <h3 class="text-uppercase text-center">Erreur du serveur interne</h3>
            </div>
            <div class="card-content">
                ...
                <div class="row py-2">
                    <div class="col-12 col-sm-6 col-md-6">
                        <a href="<?= URL::link('acceuil') ?>" class="btn btn-primary btn-block"><i class="ft-home"></i> Back to Home</a>
                    </div>
                    <div class="col-12 col-sm-6 col-md-6">
            ...
            <div class="card-footer bg-transparent">
                <div class="row">
                    <p class="text-muted text-center col-12 py-1">© 2018 <a href="#">Robust </a>Crafted with <i class="ft-heart pink"> </i> by <a href="http://themeforest.net/user/pixinvent/portfolio" target="_blank">PIXINVENT</a></p>
