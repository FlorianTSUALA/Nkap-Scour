...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>Page d'erreur - Les Comelines</title>
    <link rel="apple-touch-icon" href="<?= URL::base() ?>assets/app-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?= URL::base() ?>app-assets/images/ico/favicon.ico">
    ...
    <link rel="stylesheet" type="text/css" href="<?= URL::base() ?>assets/app-assets/css/core/menu/menu-types/horizontal-top-icon-menu.css">
    <link rel="stylesheet" type="text/css" href="<?= URL::base() ?>assets/app-assets/css/pages/error.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="<?= URL::base() ?>assets/assets/css/style.css">
    <!-- END Custom CSS-->
  </head>
