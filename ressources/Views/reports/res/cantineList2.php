...
<table  style="width:100%">
    <tr>
        <td  rowspan="4"  style="width: 13%"><img src="http://127.0.0.1/Comelines/public/assets/app-assets/images/logo/logo-80x80.png"> </td>
    ...
    <tr>
        ...
        <td  style="text-align: right;">  AC45FA4464</td>
    </tr>    
    ...
    <tr>
        <td colspan="3" style="text-align: right;"><strong class="text-danger" >0</strong></td>
    </tr> 
    <tr>
    ...
    <tr>
        ...
        <td  style="text-align: right;">Date de facturation :<strong class="text-danger" > Mardi, 24 Novembre 2020</strong></td>
    </tr> 
    <tr>
        <td colspan="3" style="text-align: left;">Elève : <strong class="text-danger" >kakambi franck</strong></td>
    </tr> 
    <tr>
        <td colspan="3" style="text-align: left;">Classe : <strong class="text-danger" >Petite-section</strong></td>
    </tr> 
    <tr>
        <td colspan="3" style="text-align: right;"> </td>
    </tr> 
