		...
		<div class="modal-content">
			...
			<form  class="needs-validation" id="create-form" method="POST"  action="" novalidate>
				<div class="modal-body">
					<div id="notification-create" style="display:none" class="alert alert-icon-right alert-info alert-dismissible mb-2" role="alert">
						<span class="alert-icon"><i class="fa fa-info"></i></span>
						<button type="button" class="close" data-dismiss="alert" >
						<!-- <button type="button" class="close" data-dismiss="alert" aria-label="Close"> -->
							<span aria-hidden="true">×</span>
						</button>
						<strong id="notification_msg-create"> Message de notification.</strong>
					</div>
				<?php
