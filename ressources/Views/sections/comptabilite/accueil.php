                ...
                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-sm-12 border-right-blue-grey border-right-lighten-5">
                                            <div class="pb-1">
                                                ...
                                                <div class="clearfix">
                                                    <span class="text-muted">Entrée jounalière</span>
                                        ...
                                        <div class="col-lg-3 col-sm-12 border-right-blue-grey border-right-lighten-5">
                                            <div class="pb-1">
                                                ...
                                                <div class="clearfix">
                                                    <span class="text-muted">Sortie jounalière </span>
                                        ...
                                        <div class="col-lg-3 col-sm-12">
                                            <div class="pb-1">
                                                ...
                                                <div class="clearfix">
                                                    <span class="text-muted">14/02/2021 </span>
                                                </div>
                                            </div>
                                            <div class="progress mb-0" style="height: 7px;">
                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="card-body">
                                <button type="button" class="btn mb-1  btn-lg btn-block"> Paiement</button>
                                <button type="button" class="btn mb-1  btn-lg btn-block"> Dépense</button>
                            </div>
                        </div>
                    </div>
                    </div>
