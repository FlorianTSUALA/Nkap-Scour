                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <td>Sous-Total</td>
                                                        <td class="text-right"><strong> <span id="recap-sous_total"><?= $sous_total??"";?></span> Fcfa</strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Remise</td>
                                                        <td class="text-right"><strong> <span id="recap-reduction"><?= $reduction??"";?> </span> Fcfa</strong></td>
                                                    </tr>
                                                    <!-- <tr>
                                                        <td>Reste</td>
                                                        <td class="text-right"><strong> <span id="recap-reste"><?= $reste??"";?> </span> Fcfa</strong></td>
                                                    </tr> -->
                                                    <!-- <tr>
                                                        <td class="text-bold-800">Total</td>
                                                        <td class="text-bold-800 text-right"> <strong> <span id="recap-total"><?= $total??"";?> </span> Fcfa</strong></td>
                                                    </tr> -->
                                                    <tr class="bg-grey bg-lighten-4">
                                                        <td class="text-bold-800">Solde à payer</td>
                                                        <td class="text-bold-800 text-right text-danger"><strong> <span id="recap-total-bottom"><?= $total??"";?></span> Fcfa</strong></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                            ...
                            <div id="invoice-footer">
                                <div class="row">
                                    ...
                                    <div class="loader-container">
                                        ...
                                        <a href="<?= URL::link('cantine_liste')?>" id="btn_home" class="btn btn-blue my-1"><i class="fa fa-home"></i> Liste des Abonnements</a>
