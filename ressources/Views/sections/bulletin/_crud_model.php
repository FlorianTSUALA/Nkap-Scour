...
use Core\HTML\Form\FormModel;
	...
	include dirname(__DIR__)."/bulletin/_crud_modal_script.php";
	include dirname(__DIR__)."/bulletin/_datatable_script.php";
			...
			<section class="row">
                ...
                <div class="card-content">
                    ...
                    <div class="float-left">
                        <p class="mb-0"><strong> <h5>Enseignant :</h5> </strong></p>
                        
                    </div>
                        <div class="float-right">
                            <p class="card-title"><strong class="float-right">salle de classe :</strong></p>
                        </div>
                    </div>
                </div>
            </div>
