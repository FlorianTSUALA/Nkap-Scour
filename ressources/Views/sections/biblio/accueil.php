                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-12 border-right-blue-grey border-right-lighten-5">
                                                <div class="pb-1">
                                                    ...
                                                    <div class="clearfix">
                                                        <span class="text-muted">Nombre de Livres</span>
                                            ...
                                            <div class="col-lg-3 col-sm-12 border-right-blue-grey border-right-lighten-5">
                                                <div class="pb-1">
                                                    ...
                                                    <div class="clearfix">
                                                        <span class="text-muted">Livres disponibles</span>
                                            ...
                                            <div class="col-lg-3 col-sm-12 border-right-blue-grey border-right-lighten-5">
                                                <div class="pb-1">
                                                    ...
                                                    <div class="clearfix">
                                                        <span class="text-muted">Livres empruntés </span>
                                            ...
                                            <div class="col-lg-3 col-sm-12">
                                                ...
                                                <div class="progress mb-0" style="height: 7px;">
                                                    <div class="progress-bar bg-warning" role="progressbar" style="width: 80%" aria-valuenow="50" aria-valuemin="90" aria-valuemax="0"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-3">
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        <button type="button" class="btn mb-1  btn-lg btn-block"> Emprunt</button>
                                        <button type="button" class="btn mb-1  btn-lg btn-block"> Restitution</button>
                                        <button type="button" class="btn mb-1  btn-lg btn-block"> Enregistrement</button>
                                        <button type="button" class="btn mb-1  btn-lg btn-block"> Historique</button>
                                    </div>
                                </div>
                            </div>
                        </div>
