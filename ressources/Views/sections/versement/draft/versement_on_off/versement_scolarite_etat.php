                            ...
                            <div id="invoice-company-details" class="row">
                                ...
                                <div class="col-md-6 col-sm-12 text-center text-md-right">
                                    ...
                                    <ul class="px-0 list-unstyled">
                                        <li>Solde à payer</li>
                                        <li class="lead text-bold-800"><strong class="text-danger" id="recap-total"><?= $somme??"" ;?> Fcfa</strong></li>
                                    </ul>
                                </div>
                            </div>
                            <!--/ Invoice Company Details -->
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    ...
                                                    <tr class="bg-grey bg-lighten-4">
                                                        ...
                                                        <td class="text-bold-800 text-right text-danger"><strong id="recap-total"><?= $total??"";?>Fcfa</strong></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
