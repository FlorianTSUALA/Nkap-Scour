                                    ...
                                    <div id="menu">
                                        <div class="list-group">
                                            ...
                                            <?php foreach($classes??[] as $item){ ?>
                                                    <li><a href="#" class="list-group-item blockquote pl-1 border-left-primary border-left-3  " data-toggle="collapse" data-target="#ID_<?= $item['domaine_id']?>" data-parent="#menu"><?= $item['domaine']; ?> <span class="badge  badge-pill bg-<?= Helpers::getRandomBootstrapColor() ?> float-right mr-2 badge-glow"><?= count($item['documents']); ?></span> </a> </li>
                                                    <div id="ID_<?= $item['domaine_id']?>" class="collapse ">
                                                        <?php foreach($item['documents'] as $sub_item){ ?>
                                                            <li><a id="ID_<?= $sub_item['document_id']?>"  class="list-group-item "><i class="fa fa-chevron-circle-right"></i>  <?= $sub_item['document']; ?> </a></li>
                                                        <?php } ?>
                                                    </div>
                                            <?php } ?>
                                        </div>
